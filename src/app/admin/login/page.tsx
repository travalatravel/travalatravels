...
export default function AdminLoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#0f172a] px-4">
      <div className="w-full max-w-md rounded-2xl border border-white/10 bg-[#1a5f94] p-8 shadow-2xl">
        <div className="mb-8 text-center">
          <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-[#2D83C2]/15">
            <ShieldCheck className="text-[#2D83C2]" size={28} />
          </div>
        ...
        <form onSubmit={isSetup ? handleSetup : handleLogin} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white outline-none placeholder:text-white/30 focus:border-[#2D83C2] focus:ring-2 focus:ring-[#2D83C2]/20"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-xl bg-[#2D83C2] py-3 text-sm font-bold text-[#1a1a1a] transition hover:bg-[#1a5f94] disabled:opacity-50"
          >

    ...
    <div className="relative mx-auto mt-10 max-w-6xl overflow-hidden px-4">
      ...
      <div className="flex animate-[marquee_40s_linear_infinite] gap-4 sm:gap-5">
        {coins.map((coin, i) => (
          <div
            key={`${coin.key}-${i}`}
            className="flex h-[72px] w-[72px] flex-shrink-0 items-center justify-center rounded-full bg-white/[0.08] shadow-[inset_0_1px_0_rgba(255,255,255,0.12),0_8px_24px_rgba(0,0,0,0.25)] backdrop-blur-sm sm:h-20 sm:w-20"
            title={coin.name}
          >
            <Image
              src={coin.symbol}

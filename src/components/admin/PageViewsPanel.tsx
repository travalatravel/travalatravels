...
export default function PageViewsPanel({
  title = "Page Views",
  description = "All tracked visits across the public site",
  showSummary = true,
  showTopPages = true,
}: {
  title?: string;
  ...
  return (
    <div>
      ...
      {showTopPages && summary && summary.topPages.length > 0 && (
        <div className="mt-6 rounded-2xl bg-white p-6 shadow-sm">
          <h3 className="font-semibold text-[#1a1a1a]">Top pages</h3>
